...
import 'package:qdrant/google/protobuf/empty.pb.dart' as $8;
...
class RaftClient extends $grpc.Client {
  ...
  static final _$addPeerToKnown =
      $grpc.ClientMethod<$7.AddPeerToKnownMessage, $7.AllPeers>(
  ...
  $grpc.ResponseFuture<$8.Empty> send($7.RaftMessage request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$send, request, options: options);
  }

  $grpc.ResponseFuture<$7.Uri> whoIs($7.PeerId request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$whoIs, request, options: options);
  }

  $grpc.ResponseFuture<$7.AllPeers> addPeerToKnown(
      $7.AddPeerToKnownMessage request,
      {$grpc.CallOptions? options}) {
...
abstract class RaftServiceBase extends $grpc.Service {
  ...
  RaftServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$7.AddPeerToKnownMessage, $7.AllPeers>(
        ...
        ($core.List<$core.int> value) =>
            $7.AddPeerToKnownMessage.fromBuffer(value),
  ...
  $async.Future<$8.Empty> send_Pre(
      $grpc.ServiceCall $call, $async.Future<$7.RaftMessage> $request) async {
  ...
  $async.Future<$7.AllPeers> addPeerToKnown_Pre($grpc.ServiceCall $call,
      $async.Future<$7.AddPeerToKnownMessage> $request) async {
  ...
  $async.Future<$7.AllPeers> addPeerToKnown(
      $grpc.ServiceCall call, $7.AddPeerToKnownMessage request);

...
class Struct extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Struct', package: const $pb.PackageName(_omitMessageNames ? '' : 'qdrant'), createEmptyInstance: create)
    ..m<$core.String, Value>(1, _omitFieldNames ? '' : 'fields', entryClassName: 'Struct.FieldsEntry', keyFieldType: $pb.PbFieldType.OS, valueFieldType: $pb.PbFieldType.OM, valueCreator: Value.create, valueDefaultOrMaker: Value.getDefault, packageName: const $pb.PackageName('qdrant'))
...
class Value extends $pb.GeneratedMessage {
  ...
  static const $core.Map<$core.int, Value_Kind> _Value_KindByTag = {
    ...
    3 : Value_Kind.integerValue,
    4 : Value_Kind.stringValue,
    5 : Value_Kind.boolValue,
    6 : Value_Kind.structValue,
    7 : Value_Kind.listValue,
    0 : Value_Kind.notSet
  };
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Value', package: const $pb.PackageName(_omitMessageNames ? '' : 'qdrant'), createEmptyInstance: create)
    ..oo(0, [1, 2, 3, 4, 5, 6, 7])
    ...
    ..aOM<Struct>(6, _omitFieldNames ? '' : 'structValue', subBuilder: Struct.create)
    ..aOM<ListValue>(7, _omitFieldNames ? '' : 'listValue', subBuilder: ListValue.create)
    ..hasRequiredFields = false
  ;
...
class ListValue extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ListValue', package: const $pb.PackageName(_omitMessageNames ? '' : 'qdrant'), createEmptyInstance: create)
